...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.Login(wd)
        self.create_contact(wd, Contact(first_name="sdfdsfdsf", middle_name="sdfsdfsdf", last_name="sdfsdfsdfds",
    ...
    def create_contact(self, wd, contact):
        ...
        wd.find_element_by_name("homepage").send_keys("www.yuwqyqwyuqwuywq.com")
        ...
        wd.find_element_by_name("phone2").send_keys(contact.second_private_number)
